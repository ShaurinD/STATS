...
Now download the GazeDetect project and open the solution in Visual Studio.  All the linkers should be correct
if you followed the instructions above.  Just build the solution and run the application.
